...
from concordcore.primitives.types import Persona, ValueType, YMLStrEnum
from concordcore.primitives.code import Code
from concordcore.primitives.varstring import VarString, VAR_PREFIX
...
class Var:
    ...
    @staticmethod 
    def Age():
        from concordcore.ontology.codes import Concord_Code_Age, CodeSystemType
        return Var(id=Concord_Code_Age, 
                   code=[Code(Concord_Code_Age,CodeSystemType.concord.value,Concord_Code_Age)]
                )
    @staticmethod 
    def Gender():
        from concordcore.ontology.codes import Concord_Code_Gender, CodeSystemType
    ...
    @staticmethod 
    def RaceEthnicity():
        from concordcore.ontology.codes import Concord_Code_Ethnicity, CodeSystemType
