...
Example usage:
    ```python
    from concordcore.core.benchmarks import BenchmarkRunner, BenchmarkReport
...
class BenchmarkRunner:
    ...
    def __init__(self, cpg_dir: str | None = None):
        """Initialize the benchmark runner.

        Args:
            cpg_dir: Directory containing CPG YAML files. If None, uses the
                     default CPG directory from the registry.
        """
        self.cpg_dir = Path(cpg_dir) if cpg_dir else None
    ...
    def benchmark_batch_processing(
        ...
        """
        from concordcore.core.batch_processor import BatchProcessor, ProcessingMode
    ...
    def benchmark_multi_cpg(
        ...
        """
        from concordcore.core.batch_processor import MultiCPGEvaluator
...
def run_benchmark_cli():
    ...
    parser.add_argument("--cpg-dir", default=None, help="CPG directory (default: auto-detect)")
