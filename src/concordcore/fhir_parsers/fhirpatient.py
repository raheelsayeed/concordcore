...
from concordcore.primitives.code import Code, CodeSystemType
from concordcore.variables import record, value, var, age
...
class FHIRPatient:
    ...
    def race_ethnicity(self):
        ...
        from concordcore.ontology.codes import Code
        from concordcore.ontology.definitions import CodeSystemType
        from concordcore.ontology.codes import CodeGender, CodeRaceEthnicity
