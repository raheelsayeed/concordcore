...
class CodeSystemType(Enum):
    ...
    CDC_RaceEthnicity  = 'urn:oid:2.16.840.1.113883.6.238' # CDC Race Ethnicity
    # https://terminology.hl7.org/2.1.0/CodeSystem-icd10CM.html
    icd10cm = 'urn:oid:2.16.840.1.113883.6.90'

    USCore_Race = 'http://hl7.org/fhir/us/core/StructureDefinition/us-core-race'
    USCore_Ethnicity = 'http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity'
